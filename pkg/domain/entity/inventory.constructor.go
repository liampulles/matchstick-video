...
// ReincarnateInventory creates an entity which was already tested and accepted - but
...
// a request.
var ReincarnateInventory = func(id ID, name string, location string, available bool) InventoryItem {
...
// NewAvailableInventory creates a brand new entity from the given parameters. The input
...
var NewAvailableInventory = func(name string, location string) (InventoryItem, error) {
